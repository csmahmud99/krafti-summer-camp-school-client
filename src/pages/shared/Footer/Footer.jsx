        ...
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-neutral text-neutral-content border-base-300">
                <div className="items-center grid-flow-col">
                    <p>Copyright &copy; {new Date().getFullYear()} | <Link to="/" className="font-bold">Krafti-Summer Camp Learning School</Link> by <a href="https://github.com/csmahmud99" rel="noreferrer" target="_blank" className="font-bold">CS Mahmud</a> <br />All Rights Reserved. </p>
                </div>
